...
class DecidirTarjetaForm(forms.Form):
    ...
    cuotas = forms.ChoiceField(choices=quotas, label='Cuotas', required=True, widget=forms.Select(attrs={'class': 'browser-default', 'placeholder':'Cuotas', 'onchange':"interest()"}))
